...
- Step 4: Drop/Replace your exported model file (MOJO/PMML) inside the model folder. Additional steps depending on what your model format are specifed in below sections. Supported formats are: **PMML**, **MOJO**. Make sure you there is only one model file of the recognised present in the model folder
